...
export default function CoursorText() {
  return (
    <div className="relative inline-block h-4 w-2">
        <span className="absolute h-4 w-[1.5px] bg-primary animate-pulse z-[1]"></span>
        <div className="absolute size-2 top-1/2 -translate-y-1/2 left-0 -translate-x-1/2 blur-sm bg-primary/50 animate-pulse "></div>
