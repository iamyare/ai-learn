...
const EventList: React.FC<{ events: ImportantEventType[] }> = React.memo(
  ({ events }) => (
...
const Chart: React.FC<{ chartData: ChartData }> = React.memo(
  ({ chartData }) => {
...
const Explanation: React.FC<{
  explanation: { context: string; explanation: string }
...
const Translation: React.FC<{
  translation: { original: string; translated: string }
}> = React.memo(({ translation }) => (
  <div className='flex flex-col gap-2 '>
